...
@section('content')
    <section id="community">
        <div class="container mt-5">
            <div class="row">
                <div class="col-lg-8 mx-auto"> <!-- Tambahkan mx-auto untuk memusatkan konten -->
                    <!-- Post content-->
                    <article>
                        <!-- Post header-->
                        <header class="mb-4">
                        ...
                        <section class="mb-5">
                            ...
                            <p class="fs-5 mb-4">The universe is large and old, and the ingredients for life as we know it
                                ...
                                Whether
                                or not the life became intelligent is a different question, and we'll see if we find that.
                            </p>
                    ...
                    <div class="d-flex justify-content-center mt-4">
                        <a href="/news" class="custom-btn">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
