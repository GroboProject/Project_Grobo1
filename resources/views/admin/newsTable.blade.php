                                    ...
                                    @else
                                        @foreach ($news as $item)
                                            ...
                                            <div class="modal fade" id="ubahBeritaModal{{ $item->id }}" tabindex="-1"
                                                aria-labelledby="ubahBeritaModalLabel{{ $item->id }}"
                                                aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"
                                                                id="ubahBeritaModalLabel{{ $item->id }}">Ubah Berita
                                                            </h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('admin.news.update', $item->id) }}"
                                                                ...
                                                                @method('PUT')
                                                                <div class="mb-3">
                                                                    <label for="judulBerita" class="form-label">Judul
                                                                        Berita</label>
                                                                    <input type="text" class="form-control"
                                                                        id="judulBerita" name="judul"
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="isi" class="form-label">Isi
                                                                        Berita</label>
                                                                    <textarea class="form-control" id="editor{{ $item->id }}" name="isi" rows="5" required>{{ $item->isi }}</textarea>
